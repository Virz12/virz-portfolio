...
<template>
  <section class="bg-polka min-h-[80vh] md:min-h-[85vh] flex-center flex-col gap-12">
    <div class="container flex flex-col items-center gap-2" v-gsap.delay-500.stagger.from="{ opacity: 0, y: 50 }">
